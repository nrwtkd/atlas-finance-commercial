    ...
    <span className={`atlasCompanion atlasCompanion--${size} atlasCompanion--${mood}`} role="img" aria-label={label}>
      <svg viewBox="0 0 160 170" aria-hidden="true">
        ...
        <g className="companionArms">
          <path d={cheering ? "M51 94C34 83 29 67 33 54" : thinking ? "M52 98C39 95 36 82 45 75" : "M52 98C38 105 35 118 40 129"} />
          <path d={cheering ? "M109 94c17-11 22-27 18-40" : guiding ? "M109 98c16-5 21-18 17-31" : "M109 98c14 7 17 20 12 31"} />
          <circle cx={cheering ? 33 : thinking ? 45 : 40} cy={cheering ? 54 : thinking ? 75 : 130} r="5" />
          <circle cx={cheering ? 127 : guiding ? 126 : 121} cy={cheering ? 54 : guiding ? 67 : 130} r="5" />
        </g>
        ...
        <path className="companionSmile" d={cheering ? "M65 105q15 17 30 0" : thinking ? "M69 108q11-5 22 0" : "M68 104q12 10 24 0"} />
